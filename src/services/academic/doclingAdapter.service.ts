...
import { CanonicalBlocksOutput, CanonicalBlock, BlockType, SemanticType } from './types';
...
export class DoclingAdapterService {
  /**
   * Repair only mechanical glyph separation produced by PDF text extraction.
   * This is language-neutral: it composes a detached accent with the following
   * letter and closes an apostrophe surrounded by letters. It does not guess or
   * rewrite words.
   */
