...
import { createRuleV3DryRunController, RuleV3DryRunDependencies } from '../../controllers/ruleV3DryRun.controller';
import { getProductionAvailabilityConfig } from '../../services/providers/ruleV3ProviderRuntime.service';
...
import { ProviderCandidate } from '../../services/providers/ruleV3GenerationProvider.types';
...
async function runTests() {
  ...
  let defaultDeps: RuleV3DryRunDependencies = {} as any;
  ...
  {
    resetDeps();
    const controller = createRuleV3DryRunController(defaultDeps);
