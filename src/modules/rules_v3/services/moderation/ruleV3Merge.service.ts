...
import { assessRuleV3MergeCompatibility } from '../evidence/ruleV3Relationship.service';
...
export async function mergePendingRuleV3Group(selectedRuleId: string) {
  ...
  // Cross-document candidates merge by semantic compatibility, not shared chunk ids.
