...
import { buildRuleV3EvidenceAnchors } from '../evidence/ruleV3EvidenceAnchor.service';
...
19. Reject candidates whose subject is a named person, identifiable character, office, protected identity, isolated object, or position-specific episode from one narrated case. A single case figure must not be converted into a general rule.
